...
今日遥感AI研究聚焦于多模态大模型在遥感图像理解中的领域适配与通用性探讨，同时涌现出针对无人机视觉定位、图像编辑基准、小目标理解及极化SAR分类等方向的新方法。多篇工作强调推理引导、跨域匹配与物理先验融合，推动遥感智能向更精细、更鲁棒的方向发展。

## ✨ 今日亮点

- 多模态大模型在遥感理解中需权衡领域专用与通用能力。
- 无人机跨域定位与图像编辑基准研究活跃。
- 物理先验与记忆增强模型助力小目标与SAR分类。

## 🗂 今日文章列表

| 标题 | 作者 | 单位 | 一句话概括 | Issue |
|---|---|---|---|---|
| [20260722] Multimodal Large Language Models for Remote Sensing Image Understanding: Domain-Specific or General-Purpose? | Ma Qiwei, Qiu Chunping, Cheng Xinjun, Zhang Xiaoyu, Duan Puhong, Yang Ke, Kang Xudong, Li Shutao | School of Artificial Intelligence and Robotics, Hunan University；Intelligent Game and Decision Lab (IGDL)；Yuelushan Center for Industrial Innovation | 探讨多模态大模型在遥感图像理解中的领域专用与通用设计权衡。 | [#2](https://github.com/ouc-xuanyu/RS-PaperClaw/issues/2) |
